...
int main(int argc, char* argv[]) {
	...
	boost::exterior_vertex_property<Graph, float>::matrix_type dist_mat(N); // NxN square matrix
	boost::exterior_vertex_property<Graph, float>::matrix_map_type dist(dist_mat, g); // connect to g
	johnson_all_pairs_shortest_paths(g, dist,
